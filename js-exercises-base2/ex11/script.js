document.getElementById("push").addEventListener("click", () => {
    function calculMoyenne(){
        let menu = prompt("Entrez un nombre entier :");
        if (menu)
...
//     tant que le nombre entré est positif ou nul, la fonction mémorise ce nombre et l'additionne aux autres nombres
//     précédemment entrés.
//     si le nombre est négatif, alors la fonction calcule la moyenne de tous les nombres entrés en divisant la somme
//     totale par le nombre de valeurs entrées.
